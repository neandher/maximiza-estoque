 ...
 */
final class Version20200305174727 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill ADD customer_id INT DEFAULT NULL, ADD referency VARCHAR(255) DEFAULT NULL, ADD quantity SMALLINT DEFAULT NULL');
